    ...
    $.ajax({
        ...
        success: function (e) {
            var t = document.getElementById("dom-target-fb"), n = t.textContent,
                ...
                o = (t = document.getElementById("dom-target-gp")).textContent, r = 1 * n.valueOf() + e.facebook,
                a = 1 * i.valueOf() + e.twitter, s = 1 * o.valueOf() + e.gplus;
...
if (function (e, t) {
        ...
        var J = [], ee = e.document, te = Object.getPrototypeOf, ne = J.slice, ie = J.concat, oe = J.push,
            re = J.indexOf, ae = {}, se = ae.toString, le = ae.hasOwnProperty, ce = le.toString, ue = ce.call(Object),
            de = {}, he = function (e, t) {
        ...
        var ve = function (e) {
            ...
            var b, x, w, C, k, T, _, S, E, A, I, D, O, P, M, L, F, N, R, W = "sizzle" + 1 * new Date, H = e.document,
                V = 0, j = 0, B = n(), z = n(), q = n(), $ = function (e, t) {
                    return e === t && (I = !0), 0
            ...
            x = t.support = {}, k = t.isXML = function (e) {
                ...
                return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, P = O.documentElement, M = !k(O), H !== O && (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), x.attributes = o(function (e) {
                    ...
                    return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === O || e.ownerDocument === H && R(H, e) ? -1 : t === O || t.ownerDocument === H && R(H, t) ? 1 : A ? Z(A, e) - Z(A, t) : 0 : 4 & n ? -1 : 1)
                } : function (e, t) {
                    if (e === t) return I = !0, 0;
        ...
        he.Callbacks = function (e) {
            ...
            Deferred: function (t) {
                ...
                var t = arguments.length, n = t, i = Array(n), o = ne.call(arguments), r = he.Deferred(),
                    a = function (e) {
                        return function (n) {
        ...
        var Ne = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
            Re = new RegExp("^(?:([+-])=|)(" + Ne + ")([a-z%]*)$", "i"), We = ["Top", "Right", "Bottom", "Left"],
            He = function (e, t) {
        ...
        var rt = /^(none|table(?!-c[ea]).+)/, at = {position: "absolute", visibility: "hidden", display: "block"},
            st = {letterSpacing: "0", fontWeight: "400"}, lt = ["Webkit", "Moz", "ms"],
        ...
        he.extend({
            ...
            he.cssHooks[t] = {
                get: function (e, n, i) {
                    ...
                    return a && (o = Re.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = he.css(e, t)), L(0, n, a)
                }
            }
        ...
        he.fn.extend({
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== r && 8 !== r && 2 !== r) return void 0 === e.getAttribute ? he.prop(e, t, n) : (1 === r && he.isXMLDoc(e) || (o = he.attrHooks[t.toLowerCase()] || (he.expr.match.bool.test(t) ? pt : void 0)), void 0 !== n ? null === n ? void he.removeAttr(e, t) : o && "set" in o && void 0 !== (i = o.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : o && "get" in o && null !== (i = o.get(e, t)) ? i : null == (i = he.find.attr(e, t)) ? void 0 : i)
            }, attrHooks: {
                type: {
                    set: function (e, t) {
        ...
        he.fn.extend({
            val: function (e) {
                var t, n, i, o = this[0];
                {
                    ...
                    if (o) return (t = he.valHooks[o.type] || he.valHooks[o.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(o, "value")) ? n : "string" == typeof(n = o.value) ? n.replace(yt, "") : null == n ? "" : n
                }
            }
        }), he.extend({
            valHooks: {
        ...
        var Et = /%20/g, At = /#.*$/, It = /([?&])_=[^&]*/, Dt = /^(.*?):[ \t]*([^\r\n]*)$/gm,
            Ot = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Pt = /^(?:GET|HEAD)$/, Mt = /^\/\//,
            Lt = {}, Ft = {}, Nt = "*/".concat("*"), Rt = ee.createElement("a");
        ...
        he.ajaxSetup({
            ...
            offset: function (e) {
                ...
                if (r) return r.getClientRects().length ? (i = r.getBoundingClientRect()).width || i.height ? (o = r.ownerDocument, n = Z(o), t = o.documentElement, {
                ...
                placement: "bottom", eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
                    ...
                    shift: {
                        order: 100, enabled: !0, fn: function (e) {
                            ...
                            if (i) {
                                var o = e.offsets.reference, r = m(e.offsets.popper),
                        ...
                        order: 400, enabled: !0, fn: function (e) {
                            var t = m(e.offsets.popper), n = e.offsets.reference, i = e.placement.split("-")[0],
                                o = Math.floor, r = -1 !== ["top", "bottom"].indexOf(i), a = r ? "right" : "bottom",
                        ...
                        order: 900, enabled: !0, fn: function (e, n) {
                            var i = {position: e.offsets.popper.position}, o = {"x-placement": e.placement},
                                r = Math.round(e.offsets.popper.left), a = Math.round(e.offsets.popper.top),
                                s = P("transform");
    ...
    return function (e, t, n, i) {
        ...
        function l(e, n, i, o) {
            ...
            function h(t, n, o) {
                var r, a, s = 0;
                do {
                    a = n + (o - n) / 2, (r = l(a, e, i) - t) > 0 ? o = a : n = a
                ...
                var C = function () {
                    ...
                    function o() {
                        ...
                        !1 !== b.mock && (!0 === b.mock ? s.duration = s.delay = 1 : (s.duration *= parseFloat(b.mock) || 1, s.delay *= parseFloat(b.mock) || 1)), s.easing = c(s.easing, s.duration), s.begin && !m.isFunction(s.begin) && (s.begin = null), s.progress && !m.isFunction(s.progress) && (s.progress = null), s.complete && !m.isFunction(s.complete) && (s.complete = null), s.display !== i && null !== s.display && (s.display = s.display.toString().toLowerCase(), "auto" === s.display && (s.display = b.CSS.Values.getDisplayType(r))), s.visibility !== i && null !== s.visibility && (s.visibility = s.visibility.toString().toLowerCase()), s.mobileHA = s.mobileHA && b.State.isMobile && !b.State.isGingerbread, !1 === s.queue ? s.delay ? setTimeout(e, s.delay) : e() : h.queue(r, s.queue, function (t, n) {
                            return !0 === n ? (S.promise && S.resolver(p), !0) : (b.velocityQueueEntryFlag = !0, void e())
        ...
        1: [function (e, t, n) {
                ...
                return e.defaults.global.legend = {
                    ...
                    initialize: function (e) {
                        ...
                        if (o.display) {
                            ...
                            u = C ? {x: n.left + (l - c[0]) / 2, y: n.top + r.padding, line: 0} : {
                                x: n.left + r.padding,
                                y: n.top + r.padding,
                                line: 0
                            };
            ...
            i = "function" == typeof i ? i : window.moment, t.exports = function (e) {
                ...
                e.Ticks.generators.time = function (e, t) {
                    ...
                    return "week" === e.unit && !1 !== a ? (n = i(t.min).startOf("isoWeek").isoWeekday(a).valueOf(), o = i(t.max).startOf("isoWeek").isoWeekday(a), t.max - o > 0 && o.add(1, "week"), o = o.valueOf()) : (n = i(t.min).startOf(e.unit).valueOf(), o = i(t.max).startOf(e.unit), t.max - o > 0 && o.add(1, e.unit), o = o.valueOf()), r(e, 0, {
                        min: n,
                        max: o
                    })
                };
        ...
        return function () {
            ...
            var u, d, h, f = 0, p = {error: "error", info: "info", success: "success", warning: "warning"}, m = {
                clear: function (e, o) {
                    ...
                    return s({type: p.info, iconClass: l().iconClasses.info, message: e, optionsOverride: n, title: t})
...
!function (e) {
    ...
    n.prototype.set = function (e, t, n) {
        ...
        var r, a = this;
        return (n = void 0 === n ? e : n) == -1 / 0 || n == 1 / 0 ? r = n : t.isPlainObject(n) && i.isInteger(n.pick) ? n = n.obj : t.isArray(n) ? (n = new Date(n[0], n[1], n[2]), n = i.isDate(n) ? n : a.create().obj) : n = i.isInteger(n) || i.isDate(n) ? a.normalize(new Date(n), o) : a.now(e, n, o), {
    ...
    return function (e, t, n, i) {
        ...
        var s, l, c, u, d, h, f, p, m, g, v, y, b, x, w, C, k, T, _, S, E, A, I, D, O, P, M, L, F, N, R, W, H, V, j, B,
            ...
            we = function (e, t) {
                ...
                shout: _e, listen: Te, viewportSize: he, options: a, isMainScrollAnimating: function () {
                    ...
                    if (he.x = r.scrollWrap.clientWidth, he.y = r.scrollWrap.clientHeight, Xe(), me.x = he.x + Math.round(he.x * a.spacing), me.y = he.y, Pe(me.x * fe), _e("beforeResize"), void 0 !== h) {
                        for (var i, s, l, c = 0; 3 > c; c++) i = C[c], Oe((c + h) * me.x, i.el.style), l = u + c - 1, a.loop && Ut() > 2 && (l = Ce(l)), (s = Xt(l)) && (w || s.needsUpdate || !s.bounds) ? (r.cleanSlide(s), r.setContent(i, l), 1 === c && (r.currItem = s, r.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === i.index && l >= 0 && r.setContent(i, l), s && s.container && (tn(s, he), an(s), De(s));
                        w = !1
                    }
            ...
            ht = 0, ft = {x: 0, y: 0}, pt = {x: 0, y: 0}, mt = {x: 0, y: 0}, gt = function (e, t) {
                ...
                return n = l > ee.min[e] || l < ee.max[e] ? a.panEndFriction : 1, l = de[e] + t[e] * n, !a.allowPanToNext && g !== r.currItem.initialZoomLevel || (te ? "h" !== ie || "x" !== e || Y || (c ? (l > ee.min[e] && (n = a.panEndFriction, ee.min[e], i = ee.min[e] - ue[e]), (0 >= i || 0 > d) && Ut() > 1 ? (s = u, 0 > d && u > st.x && (s = st.x)) : ee.min.x !== ee.max.x && (o = l)) : (l < ee.max[e] && (n = a.panEndFriction, ee.max[e], i = ue[e] - ee.max[e]), (0 >= i || d > 0) && Ut() > 1 ? (s = u, d > 0 && u < st.x && (s = st.x)) : ee.min.x !== ee.max.x && (o = l))) : s = u, "x" !== e) ? void(ne || Q || g > r.currItem.fitRatio && (de[e] += t[e] * n)) : (void 0 !== s && (Pe(s, !0), Q = s !== st.x), ee.min.x !== ee.max.x && (void 0 !== o ? de.x = o : Q || (de.x += t.x * n)), void 0 !== s)
            }, Lt = function (e) {
                ...
                var c;
                i && (0 > (u += i) ? (u = a.loop ? Ut() - 1 : 0, c = !0) : u >= Ut() && (u = a.loop ? 0 : Ut() - 1, c = !0), (!c || a.loop) && (ge += i, fe -= i, n = !0));
...
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
    ...
    var n, i, o, r = e, a = r.document, s = r.navigator, l = r.setTimeout, c = r.clearTimeout, u = r.setInterval,
        ...
        Q = new RegExp("^flash-(" + U.map(function (e) {
            ...
            var t, n, i;
            return (e = pe(e)) && !we(e) ? "ready" === e.type && !0 === H.overdue ? Ue.emit({
                type: "error",
                name: "flash-overdue"
    ...
    e.extend(e.fn, {
        ...
        prototype: {
            init: function () {
                ...
                return "radio" === o || "checkbox" === o ? e("input[name='" + i.attr("name") + "']:checked").val() : "string" == typeof(n = i.val()) ? n.replace(/\r/g, "") : n
            }, check: function (t) {
