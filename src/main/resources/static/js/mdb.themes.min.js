...
function get_social_counts() {
    ...
    $.ajax({
        ...
        dataType: "json",
        success: function (t) {
            var e = document.getElementById("dom-target-fb"), n = e.textContent,
                e = document.getElementById("dom-target-tw"), i = e.textContent,
                e = document.getElementById("dom-target-gp"), o = e.textContent, r = 1 * n.valueOf() + t.facebook,
                a = 1 * i.valueOf() + t.twitter, s = 1 * o.valueOf() + t.gplus;
...
if (function (t, e) {
        ...
        function V(t, e, n) {
            var i, o, r, a, s, l, c, u, h = "width" in e || "height" in e, d = this, f = {}, p = t.style,
                g = t.nodeType && Rt(t), v = It.get(t, "fxshow");
        ...
        var tt = [], et = t.document, nt = Object.getPrototypeOf, it = tt.slice, ot = tt.concat, rt = tt.push,
            at = tt.indexOf, st = {}, lt = st.toString, ct = st.hasOwnProperty, ut = ct.toString, ht = ut.call(Object),
            dt = {}, ft = function (t, e) {
        ...
        var gt = function (t) {
            ...
            function m(t, e, n, o, r, a) {
                return o && !o[W] && (o = m(o)), r && !r[W] && (r = m(r, a)), i(function (i, a, s, l) {
                    var c, u, h, d = [], f = [], m = a.length, v = i || p(e || "*", s.nodeType ? [s] : s, []),
                        y = !t || !i && e ? v : g(v, d, t, s, l), b = n ? r || (i ? t : m || o) ? [] : a : y;
            ...
            function y(t, n) {
                var o = n.length > 0, r = t.length > 0, a = function (i, a, s, l, c) {
                    var u, h, d, f = 0, p = "0", m = i && [], v = [], y = A, b = i || r && x.find.TAG("*", c),
                        w = j += null == y ? 1 : Math.random() || .1, C = b.length;
            ...
            var b, w, x, C, T, S, E, k, A, _, P, I, D, O, L, F, N, M, R, W = "sizzle" + 1 * new Date, H = t.document,
                j = 0, z = 0, V = n(), B = n(), q = n(), Y = function (t, e) {
                    return t === e && (P = !0), 0
                ...
                filter: {
                    TAG: function (t) {
                        ...
                        return 1 === i && 0 === o ? function (t) {
                            ...
                            var c, u, h, d, f, p, g = r !== a ? "nextSibling" : "previousSibling", m = e.parentNode,
                                v = s && e.nodeName.toLowerCase(), y = !l && !s, b = !1;
                            if (m) {
                                if (r) {
                                    for (; g;) {
        ...
        ft.Callbacks = function (t) {
            ...
            Deferred: function (e) {
                ...
                var e = arguments.length, n = e, i = Array(n), o = it.call(arguments), r = ft.Deferred(),
                    a = function (t) {
                        return function (n) {
        ...
        var Ft = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
            Nt = new RegExp("^(?:([+-])=|)(" + Ft + ")([a-z%]*)$", "i"), Mt = ["Top", "Right", "Bottom", "Left"],
            Rt = function (t, e) {
        ...
        var qt = /<|&#?\w+;/;
        !function () {
            var t = et.createDocumentFragment(), e = t.appendChild(et.createElement("div")),
        ...
        var Yt = et.documentElement, Xt = /^key/, $t = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
            Ut = /^([^.]*)(?:\.(.+)|)/;
        ft.event = {
            global: {}, add: function (t, e, n, i, o) {
                ...
                var e, n, i, o, r, a, s = ft.event.fix(t), l = new Array(arguments.length),
                    c = (It.get(this, "events") || {})[s.type] || [], u = ft.event.special[s.type] || {};
        ...
        var Qt = /<script|<style|<link/i, Gt = /checked\s*(?:[^=]|=\s*.checked.)/i, Zt = /^true\/(.*)/,
            Kt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
        ft.extend({
        ...
        var ne = /^(none|table(?!-c[ea]).+)/, ie = {position: "absolute", visibility: "hidden", display: "block"},
            oe = {letterSpacing: "0", fontWeight: "400"}, re = ["Webkit", "Moz", "ms"],
        ...
        ;ft.Animation = ft.extend(q, {
            ...
            fadeTo: function (t, e, n, i) {
                ...
                return t !== !1 && (t = t || "fx"), this.each(function () {
                    var e, n = It.get(this), i = n[t + "queue"], o = n[t + "queueHooks"], r = ft.timers,
                        a = i ? i.length : 0;
        ...
        ft.extend(ft.event, {
            trigger: function (e, n, i, o) {
                var r, a, s, l, c, u, h, d = [i || et], f = ct.call(e, "type") ? e.type : e,
        ...
        var Ce = /^(.*?):[ \t]*([^\r\n]*)$/gm, Te = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/,
            Se = /^(?:GET|HEAD)$/, Ee = {}, ke = {}, Ae = "*/".concat("*"), _e = et.createElement("a");
        _e.href = me.href, ft.extend({
            ...
            ajax: function (e, n) {
                ...
                var o, r, a, s, l, c, u, h, d, f, p = ft.ajaxSetup({}, n), g = p.context || p,
                    m = p.context && (g.nodeType || g.jquery) ? ft(g) : ft.event, v = ft.Deferred(),
                    y = ft.Callbacks("once memory"), b = p.statusCode || {}, w = {}, x = {}, C = "canceled", T = {
        ...
        ft.ajaxSetup({
            ...
            var o, r, a,
                s = e.jsonp !== !1 && (Oe.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Oe.test(e.data) && "data");
        ...
        var I = x.Utils, o = I.getScrollParent, r = I.getBounds, a = I.getOffsetParent, l = I.extend, u = I.addClass,
            c = I.removeClass, p = I.updateClasses, k = I.defer, A = I.flush, s = I.getScrollBarSize, D = function () {
        ...
        var F = {center: "center", left: "right", right: "left"}, N = {middle: "middle", top: "bottom", bottom: "top"},
            M = {
                    ...
                    key: "position", value: function () {
                        ...
                        if (this.enabled) {
                            ...
                            var u = this.cache("target-bounds", function () {
                                ...
                                }), h = u, d = y(W(this.attachment), {width: o, height: l}), f = y(W(n), h),
                                p = y(this.offset, {width: o, height: l}), g = y(this.targetOffset, h);
                            d = v(d, p), f = v(f, g);
        ...
        var V = l(z, x), P = function () {
            ...
            }(), I = x.Utils, r = I.getBounds, l = I.extend, p = I.updateClasses, k = I.defer,
...
+function (t) {
    ...
    var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        var e = "alert", i = t.fn[e], a = {DISMISS: '[data-dismiss="alert"]'},
        ...
        var e = "button", i = t.fn[e], r = {ACTIVE: "active", BUTTON: "btn", FOCUS: "focus"}, a = {
        ...
        var e = "carousel", a = "bs.carousel", s = "." + a, l = t.fn[e],
            c = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0}, u = {
                ...
                return l.prototype.next = function () {
                    ...
                    var i = this, o = t(this._element).find(p.ACTIVE_ITEM)[0], a = n || o && this._getItemByDirection(e, o),
                        s = Boolean(this._interval), l = void 0, c = void 0, u = void 0;
        ...
        var e = "collapse", a = "bs.collapse", s = t.fn[e], l = {toggle: !0, parent: ""},
        ...
        var e = "modal", a = ".bs.modal", s = t.fn[e], l = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
        ...
        var e = "scrollspy", a = t.fn[e], s = {offset: 10, method: "auto", target: ""},
            ...
            s = {
                ...
                return e.prototype.show = function () {
                    ...
                    if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(a.ACTIVE) || t(this._element).hasClass(a.DISABLED))) {
                        var n = void 0, o = void 0, l = t(this._element).closest(s.LIST)[0],
                    ...
                    var o = this, l = t(n).find(s.ACTIVE_CHILD)[0],
        ...
        var e = "tooltip", a = ".bs.tooltip", s = t.fn[e], l = {
            ...
            }, f = {FADE: "fade", SHOW: "show"}, p = {TOOLTIP: ".tooltip", TOOLTIP_INNER: ".tooltip-inner"},
            g = {element: !1, enabled: !1}, m = {HOVER: "hover", FOCUS: "focus", CLICK: "click", MANUAL: "manual"},
            v = function () {
                function s(t, e) {
    ...
    !function (r) {
        var s = "popover", l = ".bs.popover", c = r.fn[s], u = r.extend({}, a.Default, {
            ...
            }), h = r.extend({}, a.DefaultType, {content: "(string|element|function)"}), d = {FADE: "fade", SHOW: "show"},
...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity, jQuery.Velocity ? console.log("Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.") : (function (t) {
    ...
    return function (t, e, n, i) {
        ...
        var w = function () {
            ...
            function n(n, i) {
                var o = {dx: n.v, dv: t(n)}, r = e(n, .5 * i, o), a = e(n, .5 * i, r), s = e(n, i, a),
        ...
        var C = function () {
            ...
            var s, l, f, p, m, y,
                w = arguments[0] && (arguments[0].p || d.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || g.isString(arguments[0].properties));
        ...
        return b.State.isMobile || n.hidden === i || n.addEventListener("visibilitychange", function () {
            ...
            b.Redirects["slide" + e] = function (t, n, o, r, a, s) {
                var l = d.extend({}, n), c = l.begin, u = l.complete,
    ...
    var i = n.helpers = {}, o = i.each = function (t, e, n) {
        ...
        var o = Math.sqrt(Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2)),
            r = Math.sqrt(Math.pow(n.x - e.x, 2) + Math.pow(n.y - e.y, 2)), a = i * o / (o + r), s = i * r / (o + r);
        return {
    ...
    n.instances = {}, n.Type = function (t, e, i) {
        ...
        initialize: function () {
            ...
            this.stop();
            var e = this.chart.canvas, n = A(this.chart.canvas),
        ...
        inRange: function (t, e) {
            var n = i.getAngleFromPoint(this, {x: t, y: e}), o = n.angle % (2 * Math.PI),
        ...
        draw: function () {
            var t = this.ctx, e = this.width / 2, n = this.x - e, i = this.x + e, o = this.base - (this.base - this.y),
        ...
        draw: function () {
            ...
            var e = this.caretPadding = 2, n = t.measureText(this.text).width + 2 * this.xPadding,
                i = this.fontSize + 2 * this.yPadding, o = i + this.caretHeight + e;
        ...
        initialize: function () {
            ...
            var t = this.ctx.measureText(this.title).width, e = L(this.ctx, this.font, this.labels) + this.fontSize + 3,
                n = g([e, t]);
        ...
        initialize: function () {
            ...
            this.display && (t.fillStyle = this.textColor, t.font = this.font, o(this.yLabels, function (o, r) {
                ...
                var i = this.calculateX(n) + b(this.lineWidth),
                    ...
                    r = this.xLabelRotation > 0, a = this.showVerticalLines;
        ...
        initialize: function () {
            ...
            var t, e, n, i, o, r, a, s, l, c, u, h,
                d = m([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]), f = this.width, g = 0;
            ...
            if (this.display) {
                ...
                if (o(this.yLabels, function (e, n) {
                    ...
                    for (var e = this.valuesCount - 1; e >= 0; e--) {
                        ...
                        var u = this.labels.length, h = this.labels.length / 2, d = h / 2, f = e < d || e > u - d,
                            p = e === d || e === u - d;
    ...
    e.Type.extend({
        ...
        getPointsAtEvent: function (t) {
            var e = n.getRelativePosition(t),
                i = n.getAngleFromPoint({x: this.scale.xCenter, y: this.scale.yCenter}, e),
                o = 2 * Math.PI / this.scale.valuesCount, r = Math.round((i.angle - 1.5 * Math.PI) / o), a = [];
...
!function (t) {
    ...
    function s(t, e, n) {
        if (n) {
            ...
            var i = n.getAttribute("data-x"), o = n.getAttribute("data-y"), r = n.getAttribute("data-scale"),
                s = n.getAttribute("data-translate"), l = Date.now() - Number(n.getAttribute("data-hold")), c = 350 - l;
    ...
    var u = u || {}, h = document.querySelectorAll.bind(document), d = Object.prototype.toString,
    ...
    t(["jquery"], function (t) {
        return function () {
            ...
            function p(e) {
                ...
                function u(e) {
                    var n = e && y.closeMethod !== !1 ? y.closeMethod : y.hideMethod,
                        i = e && y.closeDuration !== !1 ? y.closeDuration : y.hideDuration,
                ...
                if (void 0 !== e.optionsOverride && (y = t.extend(y, e.optionsOverride), x = e.optionsOverride.iconClass || x), !function (t, e) {
                    ...
                    w++, v = n(y, !0);
                    var C = null, T = t("<div/>"), S = t("<div/>"), E = t("<div/>"), k = t("<div/>"),
                        A = t(y.closeHtml), _ = {intervalId: null, hideEta: null, maxHideTime: null},
            ...
            var v, y, b, w = 0, x = {error: "error", info: "info", success: "success", warning: "warning"}, C = {
                clear: s,
                remove: l,
                error: e,
                getContainer: n,
        ...
        this.each(function () {
            ...
            function o(e) {
                ...
                var n = window.innerHeight, o = a.innerHeight(), r = a.offset().left,
                    u = a.offset().top - t(window).scrollTop(), h = s.alignment, d = 0, f = 0, p = 0;
                s.belowOrigin === !0 && (p = o);
                var g = 0, m = a.parent();
...
dropdownSelectors.on({
    ...
    function E(t, e, n) {
        var i = n.pointers.length, o = n.changedPointers.length, r = e & Et && i - o == 0,
            a = e & (At | _t) && i - o == 0;
    ...
    var ut, ht = ["", "webkit", "Moz", "MS", "ms", "o"], dt = e.createElement("div"), ft = "function", pt = Math.round,
    ...
    var vt = s(function (t, e, n) {
            ...
            return vt(t, e, !0)
        }, "merge", "Use `assign`."), bt = 1, wt = /mobile|tablet|ip(ad|hone|od)|android/i, xt = "ontouchstart" in t,
        Ct = w(t, "PointerEvent") !== i, Tt = xt && wt.test(navigator.userAgent), St = 25, Et = 1, kt = 2, At = 4,
        _t = 8, Pt = 1, It = 2, Dt = 4, Ot = 8, Lt = 16, Ft = It | Dt, Nt = Ot | Lt, Mt = Ft | Nt, Rt = ["x", "y"],
        Wt = ["clientX", "clientY"];
    T.prototype = {
        handler: function () {
        }, init: function () {
    ...
    var Vt = {pointerdown: Et, pointermove: kt, pointerup: At, pointercancel: _t, pointerout: _t},
        Bt = {2: "touch", 3: "pen", 4: "mouse", 5: "kinect"}, qt = "pointerdown",
    ...
    t.MSPointerEvent && !t.PointerEvent && (qt = "MSPointerDown", Yt = "MSPointerMove MSPointerUp MSPointerCancel"), l(W, T, {
        handler: function (t) {
            var e = this.store, n = !1, i = t.type.toLowerCase().replace("ms", ""), o = Vt[i],
                r = Bt[t.pointerType] || t.pointerType, a = "touch" == r, s = v(e, t.pointerId, "pointerId");
    ...
    var Xt = {touchstart: Et, touchmove: kt, touchend: At, touchcancel: _t}, $t = "touchstart",
    ...
    var Qt = {touchstart: Et, touchmove: kt, touchend: At, touchcancel: _t},
    ...
    var Jt = w(dt.style, "touchAction"), te = Jt !== i, ee = "auto", ne = "manipulation", ie = "none", oe = "pan-x",
        re = "pan-y", ae = function () {
            if (!te) return !1;
                ...
                r.on("click", function () {
                    ...
                    if ("touch" == i.gesture.pointerType) {
                        var r = (i.gesture.direction, i.gesture.center.x),
                            a = (i.gesture.center.y, i.gesture.velocityX, t("body")), l = a.innerWidth();
                    ...
                    if ("touch" == n.gesture.pointerType) {
                        var i = n.gesture.velocityX, l = n.gesture.center.x, c = l - e.menuWidth,
                            u = l - e.menuWidth / 2;
        ...
        t(this).each(function () {
            ...
            if (!i.hasClass("browser-default")) {
                ...
                var l = t('<ul id="select-options-' + a + '" class="dropdown-content select-dropdown ' + (o ? "multiple-select-dropdown" : "") + '"></ul>'),
                    c = i.children("option, optgroup"), u = [], h = !1,
                    d = i.find("option:selected").html() || i.find("option:first").html() || "", f = function () {
                ...
                var v = d.replace(/"/g, "&quot;"),
                    y = t('<input type="text" class="select-dropdown" readonly="true" ' + (i.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + a + '" value="' + v + '"/>');
    ...
    function e(r, a, l, d) {
        ...
        if (!r) return e;
        var x = !1, C = {id: r.id || "P" + Math.abs(~~(Math.random() * new Date))},
            T = l ? t.extend(!0, {}, l.defaults, d) : d || {}, S = t.extend({}, e.klasses(), T.klass), E = t(r),
            k = function () {
                return this.start()
            }, A = k.prototype = {
    ...
    function n(t, e) {
        var n = this, i = t.$node[0], o = i.value, r = t.$node.data("value"), a = r || o,
            s = r ? e.formatSubmit : e.format, l = function () {
    ...
    n.prototype.set = function (t, e, n) {
        ...
        var r, a, s, l, c = this, u = n, h = o && o.interval ? o.interval : 1, d = c.item.enable === -1, f = c.item.min,
            p = c.item.max, g = d && c.item.disable.filter(function (t) {
                if (e.isArray(t)) {
        ...
        var e = this, n = e.settings, o = e.item, r = o.now, a = o.select, s = o.highlight, l = o.view, c = o.disable,
            u = o.min, h = o.max, d = function (t, e) {
            ...
            item: function (t) {
                ...
                return [i.group({
                    min: 7 * t - l.day + o + 1, max: function () {
                        ...
                        var o = a && a.pick == t.pick, d = s && s.pick == t.pick,
                            f = c && e.disabled(t) || t.pick < u.pick || t.pick > h.pick,
                            p = i.trigger(e.formats.toString, e, [n.format, t]);
    ...
    selectMonths: !0, selectYears: 15, onRender: function () {
        var t = this.$root, e = this.get("highlight", "yyyy"), n = this.get("highlight", "dd"),
    ...
    function i(i, a) {
        function l(t, e) {
            var n = h.offset(), i = /^touch/.test(t.type), o = n.left + v, r = n.top + v,
                l = (i ? t.originalEvent.touches[0] : t).pageX - o, u = (i ? t.originalEvent.touches[0] : t).pageY - r,
                d = Math.sqrt(l * l + u * u), g = !1;
            if (!e || !(d < y - w || d > y + w)) {
                t.preventDefault();
                ...
                c && h.append(P.canvas), P.setHand(l, u, !e, !0), s.off(f).on(f, function (t) {
                    t.preventDefault();
                    var e = /^touch/.test(t.type), n = (e ? t.originalEvent.touches[0] : t).pageX - o,
                        i = (e ? t.originalEvent.touches[0] : t).pageY - r;
                    (g || n !== l || i !== u) && (g = !0, P.setHand(n, i, !1, !0))
                }), s.off(p).on(p, function (t) {
                    s.off(p), t.preventDefault();
                    var n = /^touch/.test(t.type), i = (n ? t.originalEvent.changedTouches[0] : t).pageX - o,
        ...
        var u = r(T), h = u.find(".clockpicker-plate"), g = u.find(".picker__holder"), m = u.find(".clockpicker-hours"),
            S = u.find(".clockpicker-minutes"), E = u.find(".clockpicker-am-pm-block"),
            k = "INPUT" === i.prop("tagName"), A = k ? i : i.find("input"), _ = r("label[for=" + A.attr("id") + "]"),
            P = this;
    ...
    var r = window.jQuery, a = r(window), s = r(document), l = "http://www.w3.org/2000/svg",
        ...
        }(), h = "ontouchstart" in window, d = "mousedown" + (h ? " touchstart" : ""),
        f = "mousemove.clockpicker" + (h ? " touchmove.clockpicker" : ""),
        p = "mouseup.clockpicker" + (h ? " touchend.clockpicker" : ""),
        g = navigator.vibrate ? "vibrate" : navigator.webkitVibrate ? "webkitVibrate" : null, m = 0, v = 135, y = 110,
        b = 80, w = 20, x = 2 * v, C = u ? 350 : 1,
    ...
    i.DEFAULTS = {
        ...
        var e = this.currentView, n = this[e], i = "hours" === e, o = Math.PI / (i ? 6 : 30), r = n * o,
            a = i && n > 0 && n < 13 ? b : y, s = Math.sin(r) * a, l = -Math.cos(r) * a, u = this;
        ...
        var a, s = Math.atan2(t, -n), l = "hours" === this.currentView, u = Math.PI / (l || i ? 6 : 30),
            h = Math.sqrt(t * t + n * n), d = this.options, f = l && h < (y + b) / 2, p = f ? b : y;
    ...
    return function (t, e, n, i) {
        ...
        o.extend(a, i);
        var s, l, c, u, h, d, f, p, g, m, v, y, b, w, x, C, T, S, E, k, A, _, P, I, D, O, L, F, N, M, R, W, H, j, z, V,
            B, q, Y, X, $, U, Q, G, Z, K, J, tt, et, nt, it, ot, rt, at, st, lt, ct = function () {
                return {x: 0, y: 0}
            }, ut = ct(), ht = ct(), dt = ct(), ft = {}, pt = 0, gt = {}, mt = ct(), vt = 0, yt = !0, bt = [], wt = {},
            xt = !1, Ct = function (t, e) {
            ...
            }, ne = {}, ie = {}, oe = {}, re = {}, ae = {}, se = [], le = {}, ce = [], ue = {}, he = 0, de = ct(), fe = 0,
            pe = ct(), ge = ct(), me = ct(), ve = function (t, e) {
            ...
            publicMethods: {
                lazyLoadItem: function (t) {
                    ...
                    o.extend(a, tn, !0), r.items = Ye = n, Ue = r.getItemAt, Qe = a.getNumItemsFn, Ge = a.loop, Qe() < 3 && (a.loop = !1), Et("beforeChange", function (t) {
                        var e, n = a.preload, i = null === t || t >= 0, o = Math.min(n[0], Qe()),
                            s = Math.min(n[1], Qe());
        ...
        if (s = e(n), a = {
                galleryUID: n.getAttribute("data-pswp-uid"), getThumbBoundsFn: function (t) {
                    var e = s[t].el.getElementsByTagName("img")[0],
                        n = window.pageYOffset || document.documentElement.scrollTop, i = e.getBoundingClientRect();
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function (t) {
    t.fn.sticky = function (e) {
        ...
        return this.each(function () {
            function e() {
                var e = f.scrollTop();
                if (r && "string" == typeof d) var i = t(d).offset().top,
                    s = i - a - l; else if (r && "number" == typeof d) var s = d;
                if (u < e) {
            ...
            var n = t(this), a = n.outerHeight(), s = n.outerWidth(), l = i.topSpacing, c = i.zIndex,
                u = n.offset().top - l, h = t("<div></div>").width(s).height(a).addClass("sticky-placeholder"),
                d = i.stopper, f = t(window);
            f.bind("scroll", e)
        })
    }
}(jQuery), function t(e, n, i) {
    ...
    11: [function (t, e, n) {
        ...
        var r = t("../../lib/helper"), a = t("../../lib/dom"), s = t("../instances"), l = t("../update-geometry"),
            c = t("../update-scroll");
        e.exports = function (t) {
            var e = s.get(t);
            i(t, e), o(t, e)
    ...
    12: [function (t, e, n) {
        ...
        var o = t("../../lib/helper"), r = t("../../lib/dom"), a = t("../instances"), s = t("../update-geometry"),
            l = t("../update-scroll");
        e.exports = function (t) {
            i(t, a.get(t))
        }
    ...
    18: [function (t, e, n) {
        ...
        var s = t("../lib/helper"), l = t("../lib/class"), c = t("./default-setting"), u = t("../lib/dom"),
            h = t("../lib/event-manager"), d = t("../lib/guid"), f = {};
        n.add = function (t) {
            var e = d();
    ...
    19: [function (t, e, n) {
        ...
        var r = t("../lib/helper"), a = t("../lib/class"), s = t("../lib/dom"), l = t("./instances"),
            c = t("./update-scroll");
        e.exports = function (t) {
            var e = l.get(t);
    ...
    21: [function (t, e, n) {
        "use strict";
        var i = t("../lib/helper"), o = t("../lib/dom"), r = t("./instances"), a = t("./update-geometry"),
            s = t("./update-scroll");
        e.exports = function (t) {
            var e = r.get(t);
        ...
        return this.$el = t(this), this.$document = t(document), this.SELS = {
            ...
            o.$document.on("click", e.CHIPS, function (n) {
                ...
                if (!t(n.target).is("input, textarea")) {
                    var i, r = o.$document.find(e.CHIP + e.SELECTED_CHIP), a = r.closest(e.CHIPS),
                    ...
                    for (var l = 0; l < s.length; ++l) {
                        ...
                        for (var g = 0; g < o.length; g++) {
                            ...
                            if (!(m instanceof i)) {
                                ...
                                if (v) {
                                    h && (f = v[1].length);
                                    var x = v.index + f, v = v[0].slice(f), C = x + v.length, S = m.slice(0, x),
                                        E = m.slice(C), k = [g, y];
                                    S && k.push(S);
...
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
    ...
    "use strict";
    var n, i, o, r = t, a = r.document, s = r.navigator, l = r.setTimeout, c = r.clearTimeout, u = r.setInterval,
        h = r.clearInterval, d = r.getComputedStyle, f = r.encodeURIComponent, p = r.ActiveXObject, g = r.Error,
        m = r.Number.parseInt || r.parseInt, v = r.Number.parseFloat || r.parseFloat, y = r.Number.isNaN || r.isNaN,
        b = r.Date.now, w = r.Object.keys, x = r.Object.defineProperty, C = r.Object.prototype.hasOwnProperty,
        T = r.Array.prototype.slice, S = function () {
            var t = function (t) {
                return t
            };
        ...
        $ = ["flash-unavailable", "flash-degraded", "flash-overdue", "version-mismatch", "config-mismatch", "clipboard-error"],
        U = ["flash-disabled", "flash-outdated", "flash-sandboxed", "flash-unavailable", "flash-degraded", "flash-deactivated", "flash-overdue"],
        Q = new RegExp("^flash-(" + U.map(function (t) {
            ...
            if (t && /^_(?:click|mouse(?:over|out|down|up|move))$/.test(t.type)) {
                var n = t.target, i = "_mouseover" === t.type && t.relatedTarget ? t.relatedTarget : e,
                    o = "_mouseout" === t.type && t.relatedTarget ? t.relatedTarget : e, s = Ht(n),
                    ...
                    f = s.top + ("number" == typeof t._stageY ? t._stageY : 0), p = d - u, g = f - h, m = l + p, v = c + g,
            ...
            if (!e) {
                var i = Ft(r.location.host, Z), o = "never" === i ? "none" : "all", s = Ot(k({jsVersion: Ut.version}, Z)),
                    l = Z.swfPath + Dt(Z.swfPath, Z);
                n = Et();
            ...
            if (t.getBoundingClientRect) {
                var n = t.getBoundingClientRect(), i = r.pageXOffset, o = r.pageYOffset,
            ...
            var e = d(t, null);
            if (!e) return !1;
            var n = v(e.height) > 0, i = v(e.width) > 0, o = v(e.top) >= 0, r = v(e.left) >= 0, a = n && i && o && r,
                s = a ? null : Ht(t);
    ...
    var te = function (t) {
        ...
        var e = Gt[this.id], n = e && e.elements, i = !!n && n.length > 0,
            o = !t.target || i && -1 !== n.indexOf(t.target),
            r = t.relatedTarget && i && -1 !== n.indexOf(t.relatedTarget), a = t.client && t.client === this;
        return !(!e || !(o || r || a))
    }, ue = function (t) {
        var e = Gt[this.id];
